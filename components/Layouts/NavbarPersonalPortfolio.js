...
const NavbarPersonalPortfolio = () => {
  ...
  return (
    <>
      <nav id="navbar" className="navbar navbar-expand-md personal-navbar">
        <div className="container-fluid">
          <Link href="/personal-portfolio" className="navbar-brand">
            <img src="/images/portfolio/portfolio-logo.png" alt="logo" />
          </Link>
...
export default NavbarPersonalPortfolio;
