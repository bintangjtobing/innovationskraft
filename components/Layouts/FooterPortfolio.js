  ...
  return (
    <>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-footer-widget">
                <Link href="/personal-portfolio">
                  <img src="/images/portfolio/portfolio-logo.png" alt="Image" />
                </Link>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-footer-widget">
                ...
                <ul className="address">
                  ...
                  <li>
                    <a href="mailto:hello@oryx.com">hello@oryx.com</a>
                  </li>
                  <li>
      ...
      <div className="copy-right personal-copy-right">
        <div className="container">
          <p>
            Copyright &copy; {currentYear} Oryx. Designed by{" "}
