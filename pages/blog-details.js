...
import FooterITAgency from "../components/Layouts/FooterITAgency";
            ...
            <div className="col-lg-8">
              <div className="blog-details-content">
                <div className="blog-details-img">
                  <img
                    src="/images/blog-details/blog-details-img1.jpg"
                    alt="Image"
                  />
                </div>
                ...
                <div className="blog-top-content">
                  ...
                  <blockquote>
                    <p>
                      ...
                      dignissim qui blandit praesent eum iriure dolor in
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-6">
                      <div className="single-blog-post-img">
                        <img
                          src="/images/blog-details/blog-details-img2.jpg"
                          alt="Image"
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-lg-6 col-md-6">
                      <div className="single-blog-post-img">
                        <img
                          src="/images/blog-details/blog-details-img3.jpg"
                          alt="Image"
                        />
                      </div>
                    </div>
